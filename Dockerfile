...
LABEL maintainer="Marc Carré <marc@weave.works>" \
      ...
      org.opencontainers.image.url="https://github.com/weaveworks-experiments/kubernetes-deployment-strategies-workload" \
      org.opencontainers.image.source="git@github.com:weaveworks-experiments/kubernetes-deployment-strategies-workload.git" \
